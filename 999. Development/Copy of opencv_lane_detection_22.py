...
image = cv2.imread('apple.jpg') #Reading the image file
# print(image.shape)
...
def find_canny(img,thresh_low,thresh_high): #function for implementing the canny
    ...
    img_canny = cv2.Canny(img_gray,thresh_low,thresh_high)
...
lane_canny = find_canny(lane_image,0,80 )
# lane_roi = region_of_interest(lane_canny)
lane_lines = cv2.HoughLinesP(lane_canny,1,np.pi/180,20,20,5)
# print(lane_lines)
